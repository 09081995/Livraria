...
public class Endereco {
	...
	public boolean equals(Endereco endereco) {
		...
		if (endereco != null && this.rua.equals(endereco.getRua()) && this.cep == endereco.getCep()
				&& this.numero.equals(endereco.getNumero()) && this.bairro.equals(endereco.getBairro())
				&& this.cidade.equals(endereco.getCidade())) {
			resultado = true;
		}
		return resultado;
	}
